...
public class ViajeExtraRegional extends Viaje {

    public ViajeExtraRegional(int ID, OrigenDestinos origen, OrigenDestinos destino, LocalDate fechaInicioViaje, LocalTime horaPartida, Embarcacion embarcacion, int duracion) {
